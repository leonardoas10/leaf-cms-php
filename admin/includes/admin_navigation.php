...
<nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
    ...
    <div class="navbar-header">
        ...
        <a class="navbar-brand navbar-title" href="index.php">Leaf ADMIN</a>
    </div>
    <!-- Top Menu Items -->
    <ul class="nav navbar-right top-nav">
        ...
        <li class="dropdown">
            ...
            <ul class="dropdown-menu">
                <li>
                    <a href="../admin/profile.php"><i class="fa fa-fw fa-user navbar-subtitles"></i> Profile</a>
                </li>
                <li class="divider"></li>
                <li>
    ...
    <div class="collapse navbar-collapse navbar-ex1-collapse">
        <ul class="nav navbar-nav side-nav navbar-vertical">
            ...
            <li>
                <a href="/leaf-cms-php/admin/categories/"><i class="fa fa-fw fa-wrench"></i> Categories</a>
            </li>
            ...
            <li class="active">
                <a href="profile.php"><i class="fa fa-fw fa-file"></i> Profile
                </a>
            </li>
        </ul>
    </div>
