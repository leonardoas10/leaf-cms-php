...
<?php 
    ...
    if(isset($_GET['updated'])) {
        ...
        $query = "SELECT * FROM posts WHERE post_id = {$the_post_id} ";
            ...
            while($row = mysqli_fetch_assoc($select_posts_status)) {
           ...
           <div id="bulkOptionsContainer" class="col-xs-4">
            ...
            <tbody>
                ...
                <?php    
                    ...
                    echo "<td class='links-color'><a href='posts.php?source=edit_post&p_id={$post_id}'>Edit </a></td>";
                    echo "<td class='links-color'><a rel='$post_id' href='javascript:void(0)' class='delete_link'>Delete</a></td>";
                    echo "</tr>";
...
<?php 
    if(isset($_GET['delete'])) {
        ...
        $query_comments_delete = "DELETE FROM comments WHERE comment_post_id = {$delete}";
        $delete_comments_query = mysqli_query($connection, $query_comments_delete);
