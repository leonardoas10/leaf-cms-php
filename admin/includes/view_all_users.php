                           ...
                           <table class="table table-bordered table-hover tr-background">
                            ...
                            <?php 
                                ...
                                echo "<td>$user_email</td>";
                                    ...
                                    echo "<td class='links-color'><a href='users.php?source=edit_user&edit_user={$user_id}'>Edit</a></td>";
                                    echo "<td class='links-color'><a onClick=\" javascript: return confirm('Are you sure you want to delete " . strtoupper("{$username}") . "'); \" href='users.php?delete={$user_id}'>Delete</a></td>"; 
